...
code which should be benchmarked. `profile` is a function decorator 
...
deviation across all executions, and individual runs as smaller points for the
same run overlaid on the average.
